...
namespace drive{
  okapi::Motor left_back(6, false, okapi::AbstractMotor::gearset::green,
    ...
    okapi::Motor left_front(8, true, okapi::AbstractMotor::gearset::green,
      okapi::AbstractMotor::encoderUnits::degrees);
      okapi::Motor right_back(18, true, okapi::AbstractMotor::gearset::green,
        okapi::AbstractMotor::encoderUnits::degrees);
        ...
        namespace intake{
          okapi::Motor left_motor(20, false, okapi::AbstractMotor::gearset::green, //left
            okapi::AbstractMotor::encoderUnits::degrees);
            okapi::Motor right_motor(13, true, okapi::AbstractMotor::gearset::green, //right
              okapi::AbstractMotor::encoderUnits::degrees);
            ...
            namespace tilter{
              ...
              namespace lift{
                okapi::Motor motor(12, false, okapi::AbstractMotor::gearset::red,
                  okapi::AbstractMotor::encoderUnits::degrees);
