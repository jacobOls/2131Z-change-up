...
std::string buttonLabels[BUTTON_COUNT] = {
    ...
    "LR 5 fails",  "LR 4 works",   "LR 6 WIP",

    "SR  5 works", // small red
    "SR 9 WIP",    "SR ",          "SR",

    "LB 7 fails", // large blue
    "LB 4 works",  "LB 3 works",   "LB",

    "SB  5 works", // small blue
    "SB 9 WIP",    "SB ",          "SB",

    "('>){",       "deploy only ", "1 point",  "skills",
};
...
autonFnPtr autonHandlers[BUTTON_COUNT] = {
    ...
    auton::redBig5,   auton::redBig4,   auton::largeRed6,

    auton::redSmall, // small red
    auton::smallRed9, auton::blueSmall, auton::blueSmall,

    auton::blueBig, // small blue
    auton::blueBig4,  auton::safeBlue,  auton::blueSmall,

    auton::blueSmall, // large blue
    auton::blueSmall, auton::blueSmall, auton::blueSmall,

    auton::nothing, // random
    auton::doNothing, auton::onePoint,  auton::skills};
